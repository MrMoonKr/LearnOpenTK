...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        Text = "LearnOpenTK - Skeletal Animation";
        ...
        help.DropDownItems.Add("About", null, (_, _) => MessageBox.Show(
            "Plays a real animation clip on the hero body's Skeleton/AnimationClip/Animator, then CPU linear-blend-skins the body and its wearables (merged onto the body's pose by bone name) every frame.",
            "Skeletal Animation"));
