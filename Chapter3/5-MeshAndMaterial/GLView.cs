...
public sealed class GLView : GLControl
{
    ...
    private void LoadResources()
    {
        ...
        ResizeViewport();
        StatusChanged?.Invoke(this, "Loaded: Mesh owns geometry; Material owns shader selection.");
    }
    ...
    private void RenderFrame()
    {
        ...
        var model = Matrix4.CreateRotationY(time * .8f) * Matrix4.CreateRotationX(time * .5f);
