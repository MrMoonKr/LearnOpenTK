...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        view.DropDownItems.Add("Blue clear color", null, (_, _) => _view.ClearColor = Color.FromArgb(31, 52, 79));
        view.DropDownItems.Add("Green clear color", null, (_, _) => _view.ClearColor = Color.FromArgb(26, 78, 58));
        view.DropDownItems.Add("Gray clear color", null, (_, _) => _view.ClearColor = Color.FromArgb(55, 55, 55));
        var help = new ToolStripMenuItem("Help");
        help.DropDownItems.Add("About", null, (_, _) => MessageBox.Show("uModel, uView, and uProjection transform the rotating cube.", "Camera"));
        ...
        scene.Nodes.Add("Rotating cube");
        scene.Nodes.Add("Camera at (0, 0, 2), FOV 45°");
    ...
    private int Px(int p) => (int)Math.Round(p * DeviceDpi / (float)DesignDpi);
}
