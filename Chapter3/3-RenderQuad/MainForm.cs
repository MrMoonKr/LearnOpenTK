...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        var layout = new SplitContainer { Dock = DockStyle.Fill, FixedPanel = FixedPanel.Panel1, Panel1MinSize = ScaleDesignPixels(180) };
    ...
    private MenuStrip CreateMenu()
    {
        ...
        help.DropDownItems.Add("About", null, (_, _) => MessageBox.Show("GameWindow-style lifecycle callbacks hosted in a WinForms GLControl.", "About GL Tool App", MessageBoxButtons.OK, MessageBoxIcon.Information));
    ...
    private void UpdateFrameStatus() => _frameLabel.Text = $"Update: {_glView.UpdateFramesPerSecond:F1} FPS | Render: {_glView.RenderFramesPerSecond:F1} FPS";
