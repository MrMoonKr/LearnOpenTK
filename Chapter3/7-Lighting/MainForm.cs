...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        help.DropDownItems.Add("About", null, (_, _) => MessageBox.Show("Directional Key, Fill, and Rim lights.", "Lighting"));
        ...
        scene.Nodes.Add("Lit cube");
        scene.Nodes.Add("Sun (Key)");
        scene.Nodes.Add("Point Fill");
        scene.Nodes.Add("Point Rim");
